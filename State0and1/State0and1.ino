...
int redpin = 45;        // pin for red led
int bluepin = 51;       // pin for blue led
int yellowpin = 41;     // pin for yellow led
...
int col_button1 = 43;       // digital output corresponding to pushbutton 1 -- red
int col_button2 = 39;       // digital output corresponding to pushbutton 2 -- yellow
int col_button3 = 53;       // digital output corresponding to pushbutton 3 -- blue
...
//        }
//      }
      if(game_mode == HIGH){ // checking the previous state and the current state
